    ...
    {#key showPolicing}
      {#if !showPolicing}
        <div class="lens-panel lens-intro">
          ...
          <p>According to the City Life/Vida Urbana (CLVU) report, landlords frequently use eviction filings as a weapon — not necessarily to win in court, but to pressure tenants into leaving. These proceedings are often traumatic, opaque, and wielded unequally.</p>
